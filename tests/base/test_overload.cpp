...
struct Object {
    [[nodiscard]] double getValue(bool arg) const noexcept { return arg ? value : 0.; }
    double               value;
};
...
int                         main() {
    ...
    // auto overloaded_result = tnrw::makeOverloaded(&Object::getValue, func, func2, lambda, lambda2, fobj);
    // 好的定义
    auto overloaded_result = tnrw::makeOverloaded(&Object::getValue, func, func2, lambda, fobj);
    ...
    auto lambda3 = [](Object obj, bool arg) {
        ...
        return obj.getValue(!arg);
    };
    auto overloaded_result2 = tnrw::makeOverloaded(&Object::getValue, lambda3);
